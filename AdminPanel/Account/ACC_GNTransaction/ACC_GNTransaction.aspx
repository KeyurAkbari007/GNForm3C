                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td class="text-nowrap text-center">
                                                                    ...
                                                                    <asp:HyperLink
                                                                        ...
                                                                        ID="hlprint"
                                                                        SkinID="hlprint"
                                                                        NavigateUrl='<%# "~/AdminPanel/Reports/HospitalWisePatientWiseTransaction/HospitalWisePatientWiseTransaction.aspx?TransactionID=" +   GNForm3C.CommonFunctions.EncryptBase64(Eval("TransactionID").ToString()) + "&ReportType=" + GNForm3C.CommonFunctions.EncryptBase64("PDF") %>'></asp:HyperLink>
                                                                </td>
                                                            </tr>
                                                            <%-- END Table Rows --%>
                                                        </ItemTemplate>
