                        ...
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    ...
                                    <asp:HyperLink SkinID="hlAddMany" ID="hlAddMany" NavigateUrl="~/AdminPanel/Account/ACC_Income/ExpInm_LedgerListAddEditMany.aspx" runat="server"></asp:HyperLink>
                                    <asp:LinkButton SkinID="lbtnMultipleDelete" runat="server" CssClass="btn red" OnClick="btnDeleteSelected_Click"></asp:LinkButton>

                                    <%--<asp:Button ID="btnDeleteSelected" runat="server" Text="Delete Selected" CssClass="btn btn-danger" />--%>
                                ...
                                <div class="col-md-12">
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th class="vertical-align-middle justify-content-center">
