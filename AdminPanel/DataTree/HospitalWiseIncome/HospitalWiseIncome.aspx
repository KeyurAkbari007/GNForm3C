<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="HospitalWiseIncome.aspx.cs" Inherits="AdminPanel_Account_ACC_IncomeList_ACC_IncomeListPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    <asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="HospitalWiseIncome List"></asp:Label>
    <small>
        <asp:Label ID="lblPageHeaderInfo_XXXXX" runat="server" Text="Hospital"></asp:Label></small>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="HospitalWiseIncomeList"></asp:Label>
    </li>
</asp:Content>
                            ...
                            <div class="row" runat="server" id="Div_SearchResult">
                                <div class="col-md-12">
                                    ...
                                    <asp:Repeater ID="rptHospitals" runat="server" OnItemCommand="rptHospitals_ItemCommand">
                                        <HeaderTemplate>
                                            <table class="table table-bordered table-advanced table-hover">
                                                <thead>
                                                    <tr class="TRDark">
                                                        ...
                                                        <div>
                                                            <asp:Repeater ID="rptFinYears" runat="server" OnItemCommand="rptFinYears_ItemCommand">
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Button ID="btnShowIncomes" runat="server" CssClass="btn btn-transparent rounded btn-xs btn-outline green-jungle active tooltips rounded-button" Text="+" CommandName="LoadIncomes" CommandArgument='<%# Eval("FinYearID") %>' />
                                                                        </td>
