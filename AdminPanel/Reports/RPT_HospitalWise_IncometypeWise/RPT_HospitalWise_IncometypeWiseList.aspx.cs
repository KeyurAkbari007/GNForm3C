...
public partial class AdminPanel_Reports_RPT_HospitalWise_IncometypeWise_RPT_HospitalWise_IncometypeWiseList : System.Web.UI.Page
{
    ...
    protected void FillDataSet()
    {
        ...
        this.rvIncomeReport.LocalReport.DataSources.Add(new ReportDataSource("dtACC_IncomeBYHospitalAndIncomeType", (DataTable)objAcc_income.dtACC_Income));
    ...
    {
        String ReportTitleMatrix = "Income Report List";
