...
public partial class AdminPanel_Reports_HospitalWiseDateWiseExpenseList_HospitalWiseDateWiseExpenseList : System.Web.UI.Page
{
    #region 11.0 Variables

    String FormName = "Hospital Wise Date Wise Expense List";
    ...
    protected void FillDataSet()
    {
        ...
        this.rvHospitalWiseExpenseList.LocalReport.DataSources.Add(new ReportDataSource("dtACC_Expense", (DataTable)objdsACC_Expense.dtACC_Expense));
    ...
    {
        String ReportTitle = "HospitalWise | DateWise Expense List";
        ...
        this.rvHospitalWiseExpenseList.LocalReport.SetParameters(new ReportParameter[] { rptReportTitle, rptPrintDate });
    }
