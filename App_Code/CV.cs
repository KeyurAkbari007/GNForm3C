...
namespace GNForm3C
{
    public class CV
    {
       ...
       #region Page Header in AddEdit cs Code
        ...
        public static int PageRecordSize = 100;//done
        public static int PageDisplaySize = 10; //Pages Displayed in Pagination//done
        public static int DisplayIndex = 5;//done
        public static int SmallestPageSize = 20;//done
